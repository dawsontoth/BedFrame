 ...
 * then you should replace the below with simply `var BedFrame = {}`.
 */
var BedFrame = exports;
...
/**
 * Property type that results in a parent value not propagating to its children.
 */
...
BedFrame.build = function bedFrameTransformObject(target, api) {
	...
	// Return the target (this can help various IDEs code completion).
	return target;
};
